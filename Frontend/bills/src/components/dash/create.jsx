...
const Create = () => {
  ...
  const inputClass =
    "block w-full px-3 py-2 text-sm text-slate-700 bg-slate-50 border border-slate-200 rounded focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none transition-all";
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-8 text-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-slate-500 mt-2 font-medium">
              Invoice <span className="text-blue-600 font-bold">{bill.bill_no}</span> has been created for Anand
              InfoTech.
            </p>
                    ...
                    {bill.items.map((item, index) => (
                      <tr key={index} className="hover:bg-blue-50/20 group">
                        ...
                        <td className="px-3 py-3">
                          <input
                            className="w-full bg-slate-100/50 rounded px-2 py-1 text-xs"
                            placeholder="9983"
                            value={item.hsn_sac}
                        ...
                        <td className="px-3 py-3">
                          <input
                            type="number"
                            className="w-full bg-white border border-slate-200 rounded py-1 text-center font-bold text-sm"
                            value={item.qty}
                        ...
                        <td className="px-3 py-3">
                          <input
                            type="number"
                            className="w-full bg-transparent text-right focus:outline-none text-sm"
                            value={item.rate}
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <select
                      name="payment_type"
                      className="w-full font-bold text-slate-700 text-sm bg-transparent focus:outline-none"
                      onChange={handleChange}
                    >
              ...
              <div className="bg-slate-900 rounded-xl shadow-xl p-6 text-white relative overflow-hidden">
                <div className="relative z-10">
                  ...
                  <div className="pt-4 mt-4 border-t border-slate-700">
                    ...
                    <div className="text-3xl font-black text-white italic">Rs. {totalAmount.toLocaleString()}</div>
                    <p className="text-[10px] text-slate-500 mt-2 leading-tight uppercase font-medium">{toWords(totalAmount)}</p>
                  </div>
                </div>
